...
public class GameManager : MonoBehaviour
{
    ...
    private int _turn = 0;
    public int turn { get => _turn; set { _turn = value; OnTurnChanged?.Invoke(_turn); } }
    /*
     * 0 = None
     * 1 = Player 1
     * 2 = Player 2
    ...
    {
        if (player == 1)
            selectedShipPlayer1 = Mathf.Clamp(selectedShipPlayer1 - 1, 0, selectedShipPlayer1);
        else
            selectedShipPlayer2 = Mathf.Clamp(selectedShipPlayer2 - 1, 0, selectedShipPlayer2);
    }
